...
const Hero = () => {
  ...
  const roles = ["Full Stack Developer", "MERN Stack Engineer", "Problem Solver", "Software Engineer"];
      ...
      <div className="container mx-auto px-4 sm:px-6 content-center text-center sm:text-left">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Social Links Mini */}
            <motion.div variants={itemVariants} className="flex space-x-5 pt-8 justify-center sm:justify-start">
              <a href="https://github.com/ManavSinghla" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-light-accent dark:hover:text-dark-accent hover:scale-110 transition-all duration-300">
              ...
              <a href="https://linkedin.com/in/manav-singhla/" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-light-accent dark:hover:text-dark-accent hover:scale-110 transition-all duration-300">
                 <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              </a>
              <a href="mailto:manavsinghla123@gmail.com" className="text-slate-500 hover:text-light-accent dark:hover:text-dark-accent hover:scale-110 transition-all duration-300">
            ...
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
              ...
              <div className="absolute inset-8 rounded-full bg-gradient-to-tr from-light-accent to-purple-500 dark:from-dark-accent dark:to-purple-800 p-1 overflow-hidden shadow-2xl">
                 <div className="w-full h-full rounded-full bg-white dark:bg-dark-bg flex items-center justify-center overflow-hidden">
                    <img src="/manav-formal-image.png" alt="Manav Singla" loading="lazy" className="w-full h-full object-cover rounded-2xl" />
                 </div>
              </div>
            </div>
          </motion.div>
